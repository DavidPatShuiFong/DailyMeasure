...
#'
#' necessary for semantic/fomantic JS popups. included directly in
#'   datatables options
#'
...
#' javascript code to attach labels to semantic/fomantic JS pop-ups.
#' no pagination.
#'
...
#' @param paging 'pages' for long table. default is FALSE, otherwise
#'   hard to 'print'/copy a whole table
...
datatable_styled <- function(
  ...
  options <- list(
    ...
    paging = paging, scrollY = scrollY, deferRender = deferRender,
    scrollX = scrollX,
