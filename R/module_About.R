    ...
    shiny::fluidRow(
      shiny::column(10, offset = 1,
                    ...
                    shiny::a(href = "https://micromasters.mit.edu/dedp/",
                             target = "_blank", # open in new tab
                             "Data, Economics and Development Policy (MITx Micromasters) course"), shiny::br(),
    ...
    shiny::fluidRow(
      shiny::column(8, offset = 2,
                    ...
                    shiny::span(paste("Information about the users of the software, and the name of the clinic",
                                      ...
                                      "subscription databases *if* explicitly requested by the user. The information",
                    ...
                    shiny::br(), shiny::br(),
                    shiny::span(paste("Information about GPstat!/DailyMeasure usage is stored locally",
